...
BOT_TOKEN = environ.get('BOT_TOKEN', "8004559361:AAHSQN7WfNUMbMJm0Fd2VmXIgp_wYAO7AxY")
...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/vegamoviesnewin/277")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6859451629').split()]
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6859451629').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002104564413')
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002263224485')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002208017487')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", True))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mahesh81:mahesh81@cluster0.ozx17.mongodb.net/?retryWrites=true&w=majority")
...
CHNL2_LNK = environ.get('CHNL2_LNK', 'https://t.me/vegamoviesnewin')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'akDiscussion_group')
...
FIRST_CHANNEL = environ.get('FIRST_CHANNEL', '-1002101614745')
SECOND_CHANNEL = environ.get('SECOND_CHANNEL', '-1002104564413')
